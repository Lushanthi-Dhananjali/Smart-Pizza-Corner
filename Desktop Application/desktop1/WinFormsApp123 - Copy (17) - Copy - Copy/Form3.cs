...
namespace WinFormsApp123
{
    ...
    public partial class Form4 : Form
    {
        ...
        {
            //"D:\Pizza\Smart-Pizza-Corner\Desktop Application\desktop1\bill\bill"
            // Create a new document
            Document doc = new Document(PageSize.A4);

            // Specify the file path to save the PDF
            string filePath = @"D:\Pizza\Smart-Pizza-Corner\Desktop Application\desktop1\bill\bill.pdf"; // Specify the file name (e.g., "bill.pdf")
